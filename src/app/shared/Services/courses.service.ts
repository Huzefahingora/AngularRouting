...
export class CoursesService{
  ...
  courses = [
    ...
    { id:105, name:'Advance JavaScript Course', author: 'John Heikela', duration: 60, type: 'Premium',
      ...
      description: 'In this course you will learn the complete modern JavaScript step by step. This course is purely designed for beginners and teaches you all the concepts of javascript from beginner to advance level. Make you a ready JS-Dev'
    },
  ...
  apiUrl = 'https://angularlearning-b4a18-default-rtdb.firebaseio.com/courses.json'
